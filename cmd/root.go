...
func init() {
	...
	rootCmd.PersistentFlags().StringVar(&cfgFile, "config", "", "config file (default is $HOME/.kubectl-dev.yaml)")
...
func initConfig() {
	if cfgFile != "" {
		...
		// Search config in home directory with name ".kubectl-dev" (without extension).
		viper.AddConfigPath(home)
		viper.SetConfigName(".kubectl-dev")
	}
